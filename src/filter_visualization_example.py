...
def visualize_filters(model, layer_name, out_path, img_width=48, img_height=48, nb_filters=50, filter_grid_length=3):
    '''
...
visualize_filters(model, 'conv5_1', 'outputs/filters.png', img_width=48, img_height=48, nb_filters=8, filter_grid_length=2)
# input_img = K.placeholder((1, 3, img_width, img_height))
# model.layers[0].input = input_img
